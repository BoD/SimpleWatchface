...
public interface ColorPickListener {
    ...
    /**
     * Called when the user presses the "OK" top half center, indicating s/he has chosen a color.
     * @param pickedColor The chosen color.
     */
    void onOkPressed(int pickedColor);

    /**
     * Called when the user presses the "Cancel" bottom half center, indicating s/he does not want to pick a color.
     */
